...
var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_.47238411.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.5c3508d3.js"
	},
	{
		type: "style",
		href: "/assets/entry-client.1ab5b999.css"
	}
],
	"/about": [
	{
		type: "script",
		href: "/assets/about.1b80575e.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.5c3508d3.js"
	...
	{
		type: "script",
		href: "/assets/resume.b1d0b4bc.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.5c3508d3.js"
	...
	{
		type: "style",
		href: "/assets/resume.13b73991.css"
	}
],
	"/api/time": [
	{
		type: "script",
		href: "/assets/time.73bf5cd9.js"
	}
],
	"entry-client": [
	{
...
const _tmpl$$8 = ["<main", "><!--#-->", "<!--/--><!--#-->", "<!--/--><h1>Page Not Found</h1><button>Go Back</button></main>"];
function NotFound() {
...
const _tmpl$$7 = ["<a", " href=\"", "\" target=\"_blank\"><img src=\"https://img.icons8.com/color/48/000000/linkedin.png\" alt=\"LinkedIn Logo\"></a>"],
  _tmpl$2$1 = ["<a", " href=\"", "\" target=\"_blank\"><img src=\"https://img.icons8.com/ios-filled/50/000000/github.png\" alt=\"GitHub Logo\"></a>"],
  _tmpl$3 = ["<a", " href=\"", "\" target=\"_blank\"><img src=\"https://img.icons8.com/color/48/000000/twitter.png\" alt=\"Twitter Logo\"></a>"],
  _tmpl$4 = ["<a", " href=\"", "\" target=\"_blank\"><img src=\"https://img.icons8.com/color/48/000000/instagram-new.png\" alt=\"Instagram Logo\"></a>"],
  _tmpl$5 = ["<a", " href=\"", "\" target=\"_blank\"><img src=\"https://img.icons8.com/color/48/000000/facebook-new.png\" alt=\"Facebook Logo\"></a>"],
  _tmpl$6 = ["<a", " href=\"", "\" target=\"_blank\"><img src=\"https://img.icons8.com/color/48/000000/gmail.png\" alt=\"Gmail Logo\"></a>"],
  _tmpl$7 = ["<div", ">Invalid website</div>"];
function Logo(props) {
  const {
    website,
    username
  ...
  if (website === "LinkedIn") {
    return ssr(_tmpl$$7, ssrHydrationKey(), `https://www.linkedin.com/in/${escape(username, true)}`);
  } else if (website === "GitHub") {
    return ssr(_tmpl$2$1, ssrHydrationKey(), `https://www.github.com/${escape(username, true)}`);
  } else if (website === "Twitter") {
    return ssr(_tmpl$3, ssrHydrationKey(), `https://www.twitter.com/${escape(username, true)}`);
  } else if (website === "Instagram") {
    return ssr(_tmpl$4, ssrHydrationKey(), `https://www.instagram.com/${escape(username, true)}`);
  } else if (website === "Facebook") {
    return ssr(_tmpl$5, ssrHydrationKey(), `https://www.facebook.com/${escape(username, true)}`);
  } else if (website === "Mail") {
    return ssr(_tmpl$6, ssrHydrationKey(), `mailto:${escape(username, true)}`);
  } else {
    return ssr(_tmpl$7, ssrHydrationKey());
  }
}

const _tmpl$$6 = ["<main", "><!--#-->", "<!--/--><h1>About Me</h1><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--><p></p></main>"];
function Home$1() {
  return ssr(_tmpl$$6, ssrHydrationKey(), escape(createComponent(Title, {
    children: "About"
  })), escape(createComponent(Logo, {
    website: "LinkedIn",
    username: "joseph-balsavich-b539901b7"
  })), escape(createComponent(Logo, {
    website: "GitHub",
    username: "jbalsavich"
  })), escape(createComponent(Logo, {
    website: "Mail",
    username: "joseph@balsavich.dev"
  })));
}

const _tmpl$$5 = ["<button", " class=\"increment\">Clicks: <!--#-->", "<!--/--></button>"];
function Counter() {
  const [count, setCount] = createSignal(0);
  return ssr(_tmpl$$5, ssrHydrationKey(), escape(count()));
}

const _tmpl$$4 = ["<main", "><!--#-->", "<!--/--><h1>Hello There!</h1><!--#-->", "<!--/--><p>This is the new website. Visit <a href=\"https://us.balsavich.dev\" target=\"_blank\">https://us.balsavich.dev</a>to see my previous site</p></main>"];
function Home() {
...
const _tmpl$$3 = ["<div", "><iframe src=\"", "\" style=\"width:100%; height:100vh;\" frameborder=\"0\"></iframe></div>"];
function PDFViewer(props) {
  const {
    file
  } = props;
  return ssr(_tmpl$$3, ssrHydrationKey(), `https://docs.google.com/gview?url=https://us.balsavich.dev/${escape(file, true)}&embedded=true`);
}

const _tmpl$$2 = ["<button", ">Download</button>"],
  _tmpl$2 = ["<div", ">", "</div>"];
function Download(props) {
  ...
  return ssr(_tmpl$2, ssrHydrationKey(), escape(createComponent(A, {
    href: `https://us.balsavich.dev/${file}`,
    download: true,
    get children() {
...
function Resume() {
  return ssr(_tmpl$$1, ssrHydrationKey(), escape(createComponent(Title, {
    children: "Resume"
  })), escape(createComponent(PDFViewer, {
    file: "/resume/Resume-08_04_2022.pdf"
  })), escape(createComponent(Download, {
    file: "/resume/Resume-08_04_2022.pdf"
  })));
}
...
const _tmpl$ = ["<div", " class=\"nav-bar\"><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--><!--#-->", "<!--/--></div>"];
function Root() {
